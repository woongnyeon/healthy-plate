                  ...
                  ingredients.map((ingredient) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-gray-400 text-xs">{ingredient.amount}g</span>
                      ...
                      <div className="h-1.5 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div
                          className={`h-full rounded-full ${
                             // A little variation in color purely for aesthetics or just keep orange?
                             // The image shows mostly orange/reddish bars. Let's stick to base orange or a gradient if we felt fancy, 
                             // but the image shows: Top one orange, Bottom one red.
                             // We can alternate or just use orange. Let's stick to the brand orange.
                             "bg-gradient-to-r from-[#FF8A00] to-[#FF6B00]"
                          }`}
